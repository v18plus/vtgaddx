...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "vtgapibot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "vtgapibot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/vtgapibot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/vtgapibot"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "❤️ @Graclex")
